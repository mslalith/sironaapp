...
class _AddPlaceScreenState extends State<AddPlaceScreen> {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    final staticUrl = LocationHelper.previewImage(
  ...
  void addOrder(
      BuildContext ctx, String imageUrl1, String imageUrl2, String desc) async {
  ...
  Widget build(BuildContext context) {
    ...
    void fetchAddress() async {
      final number = Provider.of<Auth>(context, listen: false).number;
      await addressData.fetchAddress(number);
      setState(() {
        dropAddr = addressData.baseAddress;
      });
    }

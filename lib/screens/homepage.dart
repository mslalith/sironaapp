...
List<String> imgList = [];
 ...
 final CarouselController _controller = CarouselController();
  ...
  //   _getAddress();
    ...
    Navigator.of(context).pushNamed(AddPin.routeName,  arguments: {'mode' : 'add'});
  }
  ...
  Future<void> locationDialog(BuildContext context) {
    ...
    final addressData = Provider.of<AddressList>(context,listen: false);
    isLocationPicked = addressData.checkAddress();
    return isLocationPicked ? Container()  : showDialog(     
        context: context,
            ...
            content: Container(
             ...
             child: Column(
               children: <Widget>[
                ...
                width: deviceSize.width * 0.8,
                child: Image.asset('lib/assets/images/building.png', fit: BoxFit.cover), ),
                   Padding(
                     padding: EdgeInsets.fromLTRB(deviceSize.width * 0.3,deviceSize.height * 0.08,deviceSize.width * 0.1, 0),
                     child: Container(
                height: deviceSize.height * 0.06,
                width: deviceSize.width * 0.1,
                child: Image.asset('lib/assets/images/location.png', fit: BoxFit.contain ),
                   ),),
                 ],
               ),
               Text('Please allow location access to', style: TextStyle(
                 fontSize: deviceSize.height * 0.015,
                 color: Color(0xff707070)
               ),),
               Text('check delivery service availabilty', style: TextStyle(
                 fontSize: deviceSize.height * 0.015,
                 color: Color(0xff707070)
               ),),
               ],
  ...
  child: Container(
    ...
    this.isLocationPicked ? addresscheck() :
    ...
    return Column(
        ...
        Container(
          ...
          Padding(
            ...
            top:deviceSize.height * 0.07, bottom: 0),
            child: Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                   Column(
                     ...
                     children: <Widget>[
                       Padding(
                         padding: EdgeInsets.fromLTRB(0,0,0,deviceSize.height * 0.007),
                         child: Text('Order With Prescription',
                         style: TextStyle(
                       ...
                       Text('Upload your prescription & relax,', 
                       style: TextStyle( color: Color(0xff707070),
                       fontFamily: 'Roboto'),),
                       Text('we will do the rest', style: TextStyle( color: Color(0xff707070),
                       fontFamily: 'Roboto'
                       ,),)
                     ],
                   ),
                  Stack(
                    children: <Widget>[
                      Positioned(
                        ...
                        child: Image.asset('lib/assets/images/medpres.png', height: deviceSize.height * 0.06,),
                      ),
                     
                  Padding(
                          padding: EdgeInsets.only(top: deviceSize.height * 0.05, left: deviceSize.width * 0.05),
                          child: ButtonTheme(
                ...
                children: <Widget>[
                   Column(
                     ...
                     children: <Widget>[
                       ...
                       Text('No prescription? still you', style: TextStyle( color: Color(0xff707070),),),
                       Text('can place your requirement', style: TextStyle( color: Color(0xff707070),),)
                     ],
                   ),
                   Container(),
                    Stack(
                    children: <Widget>[
                      Positioned(
                        ...
                        child: Image.asset('lib/assets/images/tabpres.png', height: deviceSize.height * 0.06,),
                      ),
       ...
       borderRadius: BorderRadius.only(topRight:  Radius.circular(150),
        ...
        color: Color(0xff84bb40),
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(deviceSize.width * 0.035,deviceSize.width * 0.03,deviceSize.width * 0.01,deviceSize.width * 0.01),
                child: Image.asset('lib/assets/images/headCall.png', fit: BoxFit.cover,),
              ),
              Padding(padding: EdgeInsets.fromLTRB(deviceSize.width * 0.2,deviceSize.width * 0.01,deviceSize.width * 0.01,deviceSize.width * 0.01),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                 ...
                 Container(height: deviceSize.height * 0.005,),
                  Text('Contact our customer support', style: TextStyle(
                    color: Color(0xff707070),
              ...
              Padding(padding: EdgeInsets.fromLTRB(deviceSize.width * 0.75,deviceSize.width * 0.03,deviceSize.width * 0.01,deviceSize.width * 0.01),
              child: InkWell(
              onTap: () => _makePhoneCall('tel:+917997123400'),
              child:  Image.asset('lib/assets/images/call.png', fit: BoxFit.cover,)
              ),),
              Padding(padding: EdgeInsets.fromLTRB(deviceSize.width * 0.88,deviceSize.width * 0.03,deviceSize.width * 0.01,deviceSize.width * 0.01),
              child: InkWell(
              onTap: (){
                         FlutterOpenWhatsapp.sendSingleMessage("+917997123400", "Hello");
                        },
              child:  Image.asset('lib/assets/images/whatsapp.png', fit: BoxFit.cover,)
              ),)
              ],
            ),
            ),

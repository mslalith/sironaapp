...
class _AddPinState extends State<AddPin> {
  ...
  String err = 'Currently we are not operative in your area! Don\'t Worry, we will be coming soon';
  String err1 = '' ;
...
void checkNext(BuildContext ctx) {
 ...
 void _setPin(){  
        ...
        builder: (BuildContext context) {
          return new AlertDialog(
            ...
            Container(
              ...
              child: Image.asset('lib/assets/images/noPIN.png', fit: BoxFit.contain ),
                 ),
            Container(
              height: deviceSize.height * 0.03,
            ),
            ...
            Container(
              width: deviceSize.width * 0.8,            
              child: Center(
                child: Text('Currently we are not operative in your area! \n Don\'t Worry, we will be coming soon.', 
                textAlign: TextAlign.center,
                style: TextStyle(
  ...
  this.locationCheck ? Container() :
    ...
    body: isLoading ? SplashScreen() : SingleChildScrollView(
      child: Column (
       children: <Widget>[
         editFlag ? 
         Container(
               ...
               Padding(
                ...
                Padding(
                 ...
                 child: TextField(
                   ...
                   maxLength: 20,
                    decoration: InputDecoration(
                      labelText: 'Label Eg: Home, Work, Other etc..',
                      counterText: "", 
                    ),
                 ),),
               ),              
      ...
      markers: {
       ...
       onTap: isSelecting ? _selectLocation : null,
              ...
              Row(
               ...
               child: Text('$address', 
               style: TextStyle(color: Color(0xff666666), fontSize: deviceSize.height * 0.02),
              ...
              InkWell(
                ...
                size: deviceSize.height * 0.02),
                  Text(' Edit',style: TextStyle(color: Colors.red, fontSize: deviceSize.height * 0.017),)
                ],)
              )
              ],),
            ...
            Container(
              height: deviceSize.height * 0.03,
              child: Center(
                child: Text('$err1', style: TextStyle(
                  color: Colors.red)
                ),
              ),
            ),
            ButtonTheme(
                ...
                onPressed: () => 
                editFlag ? 
                locationCheck ? addAddress(context) : null  
                : editAddress() , 
                child: Text("CONFIRM",

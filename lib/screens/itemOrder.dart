      ...
      body: Container(
        child: Column(
          ...
          children: <Widget> [
                          ...
                          children: <Widget>[
                            Container(
                             ...
                             borderRadius: BorderRadius.circular(100),
                              ...
                              child: Center(child: Text('+', style: TextStyle(color: Color(0xff83BB40)),)),),
                            Container(
            ...
            Expanded(
              flex: 3,
              child: itemCnt != 0 ? ListView.builder(
              itemCount: itemCnt,
                ...
                child: Card(                 
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      IconButton(icon: Image.asset('lib/assets/images/deIcon.png') , onPressed: () => showAlert(items[index])  
        ,)
                    ],
                  ),
                  Padding(
                    padding: EdgeInsets.fromLTRB(deviceSize.width * 0.085,0,deviceSize.width * 0.2,0),
                    child: Container(
                      height: 0.5,
                  ...
                  Row(
                    ...
                    Container(
                      ...
                      , style: TextStyle(fontSize: deviceSize.height * 0.019),)
                      ),
                      Container(
                         padding: EdgeInsets.all(10),
                         child:
                      Text('${items[index].type}'
                      , style: TextStyle(fontSize: deviceSize.height * 0.019, color: Color(0xffA2A2A2)),)
                      ),
                    ] ,
                  )
                    ],
